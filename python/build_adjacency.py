...
map = gpd.read_file('./python/REGIONE_LOMBARDIA/Comuni_correnti_poligonali.shp') # load file as a geodataframe
...
pd.DataFrame(adjacency_tuples).to_csv("./python/adjacency_files/adjacency_tuples.csv", index=False)
pd.DataFrame(adjacency_m).to_csv("./python/adjacency_files/adjacency_matrix.csv", index=False)