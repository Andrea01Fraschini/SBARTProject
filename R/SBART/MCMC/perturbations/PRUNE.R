#' Prune Decision Tree
#'
#' This function attempts to prune the decision tree by proposing to merge two terminal nodes that share the same parent. 
...
#' result = PRUNE(sigma2, sigma_mu, dt, residuals, prop.prob, obs, x.list, xcut, n.available, prob.grow, prob.change, prob.prune, alpha, beta)
#' @export
#'
PRUNE <- function(
