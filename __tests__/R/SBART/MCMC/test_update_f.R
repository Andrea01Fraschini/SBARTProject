...
describe("Test sample_variance function",{
    ...
    it("Should return a list with the correct classes",{
        expect_is(f_update_results$W_sel.samples, "numeric")
        ...
        expect_is(f_update_results$Wstar.eigen, "list")
    ...
    it("Should return kim's output",{
        ...
        expect_equal(f_update_results$W.post.full, output_update_f$W.post.full)
