...
for(j in 2:n.iter){
    ...
    generate_output(output, "output_sbart_step_2", FALSE, j == 2)
    generate_output(output, "output_sbart_step_10", TRUE, j == 10)
    # END CODE FOR TESTS---------
...
# CODE FOR TESTS-------------
    ...
    generate_output(output, "output_sbart_full", TRUE)
    # END CODE FOR TESTS---------
